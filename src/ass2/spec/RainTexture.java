...
public class RainTexture {
	...
	public RainTexture(GL2 gl, String fileName,String extension,boolean mipmaps) {
	...
	public RainTexture(GL2 gl, ByteBuffer buffer, int size,boolean mipmaps) {
		mipMapEnabled = mipmaps;
		gl.glGenTextures(1, textureID, 0);
		gl.glBindTexture(GL.GL_TEXTURE_2D, textureID[0]);
